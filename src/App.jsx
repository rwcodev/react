...
import myvideo from './assets/fondo5.mp4'
...
function App() {
  ...
  return (
    <div className='min-h-screen flex justify-center items-center bg-cover' style={objStyle}>
      <h1 className = 'absolute top-40 text-3xl uppercase font-bold'>Galleta de la fortuna</h1>
      ...
      <BtnPhrase 
        ...
        <div>
          <video src={myvideo} autoPlay muted/>  
        </div>
